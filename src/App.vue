...
export default {
  ...
  setup() {
    ...
    // Utilisation de onMounted ici
    onMounted(() => {
      // Vous pouvez appeler HandleTopSearch ici ou d'autres actions à effectuer après le montage du composant
      HandleTopSearch();
    });
    ...
    return {
      ...
      animelist,
      HandleSearch,
      HandleTopSearch, // Si vous souhaitez exposer cette fonction pour une utilisation dans le template
    };
  },
};
</script>
